...
import (
	v1alpha1 "github.com/samsung-cnct/cluster-controller/pkg/client/clientset/versioned/typed/clustercontroller/v1alpha1"
...
func (c *FakeSamsungV1alpha1) KrakenClusters(namespace string) v1alpha1.KrakenClusterInterface {
	return &FakeKrakenClusters{c, namespace}
}
